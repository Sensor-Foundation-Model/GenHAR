...
from models.GenHAR import TimeSeriesTransformer
import argparse
...
parser.add_argument("--label_dir", default='./dataset')
parser.add_argument("-d", "--dataset", default='SBHAR', type=str)
parser.add_argument("-td", "--target_dataset", default='SBHAR', type=str)
...
parser.add_argument("--save_excel_path", default='./excel_result')
...
class Main_Transformer:
    ...
    def loop_train_and_test(self):
        ...
        dataset_list = ['SBHAR', 'shoaib', 'MotionSense', 'hhar']
